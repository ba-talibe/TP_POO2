 ...
 * @inv <pre>
 *     getCurrencyNb() >= 2
 *     forall i,j, 0 <= i < getCurrencyNb(), 0 <= j < getCurrencyNb() :
 *         getCurrency(i) != null
 *         getExchangeRate(i, j) ==
 ...
 * @cons
 * $DESC$
 *     Le modèle est initialisé avec des montants nuls, des devises toutes
 *      égales à la devise de référence.
 * $ARG$
 *     Currency refCur, int n
 * $PRE$
 *     refCur != null && n >= 2
 * $POST$
 *     getCurrencyNb() == n
 *     forall i, 0 <= i < n :
 *         getCurrency(i) == refCur
 *         getAmount(i) == 0.0
 */
