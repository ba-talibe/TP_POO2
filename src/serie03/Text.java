 ...
 * @inv <pre>
 *     getLinesNb() >= 0
 *     forall i, 1 <= i <= getLinesNb() : getLine(i) != null
 *     getContent() != null
 *     getContent().equals(
 *         concat(1 <= i <= getLinesNb(), getLine(i) + NL)) </pre>
 * @cons
 * $DESC$
 *     Un texte vide
 * $ARGS$
...
public interface Text {
     ...
     * @pre <pre>
     *     1 <= numLine <= getLinesNb() + 1
     *     s != null </pre>
     * @post <pre>
     *     getLinesNb() == old getLinesNb() + 1
     *     getLine(numLine).equals(s)
     *     forall i, numLine + 1 <= i <= getLinesNb() :
     ...
     * @pre <pre>
     *     1 <= numLine <= getLinesNb() </pre>
     * @post <pre>
     *     getLinesNb() == old getLinesNb() - 1
     *     forall i, numLine <= i <= getLinesNb() :
     *         getLine(i).equals(old getLine(i + 1)) </pre>
     */
